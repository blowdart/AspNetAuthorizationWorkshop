...
* Add cookie middleware into Configure() before the call to `app.UseMvc()`:
...
* Run the application and confirm you are logged in. Note that the authentication cookie is valid for 20 minutes, so if you haven't closed your browser, you will need to clear your cookies to log in (or use incognito, different browser, etc.).
